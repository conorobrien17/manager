...
urlpatterns = [
    ...
    path("employees/<int:pk>/", UserDetailView.as_view(), name="user-detail"),
    path("employees/<int:pk>/profile", UserDetailView.as_view(), name="user-detail"),
    path("employees/<int:pk>/edit", UserEditView.as_view(), name="user-edit"),
