...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['username'],
                'permissions': [('edit_all_users', 'Can edit any user'), ('edit_username', "Can edit a user's username"), ('edit_department', 'Can assign a user to a department'), ('edit_staff_status', "Can edit a user's staff status"), ('view_phone_number', "Can view a user's phone number")],
            },
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='The name of the department', max_length=128, unique=True)),
